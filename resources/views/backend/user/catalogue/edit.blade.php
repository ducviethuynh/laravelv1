...
<form action="{{ route('user.catalogue.update', $catalogue->id) }}" method="post" class="box">
    @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input type="text" name="name" class="form-control" value="{{ old('name') ?? $catalogue->name }} ">
                                    @if($errors->has('name'))
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input type="text" name="description" class="form-control" value="{{ old('description') ?? $catalogue->description }}">
                                </div>
                            </div>
                        </div>
                    </div>
